...
export default function Filters() {
  ...
  const [make] = useState(new Set(...[searchParams.get("make")?.split(",")]));
  const [type] = useState(new Set(...[searchParams.get("type")?.split(",")]));
  ...
  const initilizePage = async () => await getMake();
  ...
  useEffect(() => {
    const filter = Object.keys(sort)[0] as "price" | "milage";
    const sortedCars = cars.toSorted((a, b) =>
      sort[filter] === "asc" ? a[filter] - b[filter] : b[filter] - a[filter]
    );
    setCars(sortedCars);
  }, [sort]);
  return (
      ...
      <div className="bg-white   h-full">
        ...
        <main className=" mx-auto  pb-72 sm:px-6 bg-white h-full ">
          <div className="flex items-baseline  bg-white justify-between border-b border-gray-200 pb-6 pt-12">
            <h1 className="ml-5 text-4xl font-bold tracking-tight text-gray-900">Cars</h1>
            ...
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                <div className="grid grid-cols-2   justify-center  ">
                  ...
                  <Menu.Button className="group ml-2  self-center inline-flex justify-center  text-sm font-medium text-gray-700 hover:text-gray-900">
                    Sort
                    <ChevronDownIcon
              ...
              <button
                type="button"
                className=" mr-4 p-2 text-gray-400 hover:text-gray-500 sm:ml-6 lg:hidden"
          ...
          <div>
            ...
            <div className="grid grid-cols-1 bg-white h-full gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <div className="lg:col-span-4 h-full w-5/6 bg-white justify-self-center 	">{<Cars products={cars} />}</div>
            </div>
          </div>
        </main>
      </div>
